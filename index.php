        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="bd-placeholder-img" src="images/banner-1.png" width="100%" /> 

                    <div class="container">
                        <div class="carousel-caption text-start">
                            <h1>Example headline text.</h1>
                ...
                <div class="carousel-item">
                    <img class="bd-placeholder-img" src="images/banner-2.png" width="100%" /> 
                ...
                <div class="carousel-item">
                    <img class="bd-placeholder-img" src="images/banner-3.png" width="100%" /> 
